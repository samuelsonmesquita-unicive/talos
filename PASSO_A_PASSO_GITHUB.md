...
git commit -m "feat(hermes): implementação inicial do módulo hermes com encargos da folha (+***%)"
...
git add .
git commit -m "feat: código inicial do Módulo Hermes com encargos da folha (+***%)"
